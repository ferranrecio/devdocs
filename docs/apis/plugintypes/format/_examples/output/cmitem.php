...
/**
 * The [pluginname] course course module item output class.
 *
 * @package   format_[pluginname]
 * @copyright 2022 Someone <someone@somewhere.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace format_[pluginname]\output\courseformat\content\section;
...
class cmitem extends cmitem_base {
    ...
    public function get_template_name(\renderer_base $renderer): string {
        return 'format_[pluginname]/local/content/section/cmitem';
    }
}
